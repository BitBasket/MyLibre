...
| `PGP_USER_PUBLIC_KEY_PATH` | User public key written by `POST /api/keys`. Default `data/keys/user-public.asc`. When the file exists, outbound snapshots are encrypted to it. |
